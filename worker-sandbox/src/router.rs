use crate::{
    alarm, analytics_engine, assets, cache, counter, d1, fetch, form, kv, queue, r2, request,
    service, socket, sql_counter, sql_iterator, test, user, ws, SomeSharedData, GLOBAL_STATE,
};
#[cfg(feature = "http")]
...
macro_rules! add_routes (
    ...
    add_route!($obj, get, "/durable/put-raw", test::put_raw::handle_put_raw);
    ...
    add_route!($obj, get, "/durable/auto-response", test::auto_response::handle_auto_response);
    add_route!($obj, get, "/durable/hello", test::durable::handle_hello);
    add_route!($obj, get, "/durable/hello-unique", test::durable::handle_hello_unique);
    add_route!($obj, get, "/durable/storage", test::durable::handle_storage);
    add_route!($obj, get, "/durable/handle-basic-test", test::durable::handle_basic_test);
